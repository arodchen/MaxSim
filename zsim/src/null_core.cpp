...
void NullCore::LoadFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base) {}
void NullCore::StoreFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base) {}
void NullCore::PredLoadFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base, BOOL pred) {}
void NullCore::PredStoreFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base, BOOL pred) {}
